...
const VideoPlaying = () => {
  ...
  const addToLikedVideosHandler = async () => {
    if (!authState.isLoggedIn) {
      ...
      const playlistID = playlistState.library.find(
      ...
      <div className="note-taking-container">
        ...
        <div className="text-input">
          <input
            ...
            disabled={authState.isLoggedIn ? null : "disabled"}
          />
          <button
            onClick={() => addToNotesHandler(id)}
            disabled={authState.isLoggedIn ? "" : "disabled"}
          >
